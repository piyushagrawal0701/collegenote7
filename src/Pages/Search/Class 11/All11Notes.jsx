...
{/* <!-- ----------------------------- SEARCH SECTION (11 DETAILED NOTES) -------------------------  --> */}
    ...
    <section>
      ...
      <div className="container">
        <Link to="/search_11_full_notes"><div className={filteredItems('main')}>Physics ( Class 11th )</div></Link>
        
        <Link to="/search_11_full_notes"> <div className={filteredItems('main')}>Chemistry ( Class 11th )</div></Link>

        <Link to="/search_11_full_notes"><div className={filteredItems('main')}>Maths ( Class 11th )</div></Link>
