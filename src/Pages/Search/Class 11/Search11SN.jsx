...
// import CnofAnalysisUnit1pg01 from './Class Notes/Analysis/Unit 1/Analysis-CN-Unit1_page-0001.jpg'
// import CnofAnalysisUnit1pg02 from './Class Notes/Analysis/Unit 1/Analysis-CN-Unit1_page-0002.jpg'
// import CnofAnalysisUnit1pg03 from './Class Notes/Analysis/Unit 1/Analysis-CN-Unit1_page-0003.jpg'
// import CnofAnalysisUnit1pg04 from './Class Notes/Analysis/Unit 1/Analysis-CN-Unit1_page-0004.jpg'
// import CnofAnalysisUnit1pg05 from './Class Notes/Analysis/Unit 1/Analysis-CN-Unit1_page-0005.jpg'
    ...
    <div className="tab">
        ...
        <div id="unit1" className="tabcontent">
            ...
            <section className="unit1Content">
                ...
                <h2 className="movie-h1 webSeries-h1 movie-h1-transition  "  style={{fontSize:"xx-large " ,marginTop:"6% " }}>Short Notes</h2>
            </div> 
                <div>
                 ...
                 <section>
                     <div className='jeenotestable'>
                        ...
                        <tr>
                            <td>2</td>
                            <td>Kinematics</td>
                            <td className='boxHover'><a href="" download={"Kinematics Short Notes PDF"}>PDF Download</a></td>

                        </tr>
                        <tr>
                            <td>3</td>
                            <td>Laws of Motion</td>
                            <td className='boxHover'><a href="" download={"Laws of Motion Short Notes PDF"}>PDF Download</a></td>
                        
                        </tr>
                        <tr>
                            <td>4</td>
                            <td>Work, Energy and Power</td>
                            <td className='boxHover'><a href="" download={"Work, Energy and Power Short Notes PDF"}>PDF Download</a></td>

                        </tr>
                        <tr>
                            <td>5</td>
                            <td>Rotational Motion</td>
                            <td className='boxHover'><a href="" download={"Rotational Motion Short Notes PDF"}>PDF Download</a></td>
                        
                        </tr>
                        <tr>
                            <td>6</td>
                            <td>Gravitation</td>
                            <td className='boxHover'><a href="" download={"Gravitation Short Notes PDF"}>PDF Download</a></td>
                        ...
                        <tr>
                            ...
                            <td className='boxHover'><a href="" download={"Properties fo solids and liquids Short Notes PDF"}>PDF Download</a></td>
                        ...
                        <tr>
                            ...
                            <td className='boxHover'><a href="" download={"Thermodynamics Short Notes PDF"}>PDF Download</a></td>
                        ...
                        <tr>
                            <td>9</td>
                            <td>KTG</td>
                            <td className='boxHover'><a href="" download={"KTG Short Notes PDF"}>PDF Download</a></td>
                 ...
                 <section>
                     <div className='jeenotestable'>
                        ...
                        <tr>
                            ...
                            <td className='boxHover'><a href="" download={"Conic Section Short Notes PDF"}>PDF Download</a></td>

                        </tr>
                        <tr>
                            <td>12</td>
                            <td>Mathematical Reasoning</td>
                            <td className='boxHover'><a href="" download={"Mathematical Reasoning Short Notes PDF"}>PDF Download</a></td>
