    ...
    <div className="tab">
        ...
        <div id="unit1" className="tabcontent">
            ...
            <section className="unit1Content">
                ...
                <h2 className="movie-h1 webSeries-h1 movie-h1-transition  "  style={{fontSize:"xx-large " ,marginTop:"6% " }}>Algorithm</h2>
            </div> 
                <div>
                ...
                <section className="notes-Images-Section">
                    ...
                    <img src={CnofAnalysisUnit1pg01} alt=""/>
                ...
                <div>
                    ...
                    <img src={CnofAnalysisUnit1pg02} alt=""/>
                ...
                <div>
                    ...
                    <img src={CnofAnalysisUnit1pg03} alt=""/>
            ...
            {/* <!-- // HORIZONTAL ADS FILE BETWEEN IMAGES // --> */}
                    ...
                    <img src={CnofAnalysisUnit1pg04} alt=""/>
                    ...
                    <img src={CnofAnalysisUnit1pg05} alt=""/>
        ...
        <section className="unit1Content">
                ...
                <h2 className="movie-h1 webSeries-h1 movie-h1-transition  "  style={{fontSize:"xx-large " ,marginTop:"6% " }}>Greedy Algorithm</h2>
            </div> 
                <div>
                    <h2 className="Btna" style={{marginTop:"10%"}}>Coming Soon... <span >&nbsp;       &nbsp;  </span>   </h2>
                    {/* <!-- <h2 className="Btna" style="margin-top: 0%;">Jao usse padao</h2> --> */}
        ...
        {/* <!-- ---- UNIT 3 CONTENT ------  --> */}
            ...
            <div id="unit3" className="tabcontent">
                ...
                <section className="unit1Content">
                        ...
                        <h2 className="movie-h1 webSeries-h1 movie-h1-transition  "  style={{fontSize:"xx-large " ,marginTop:"6% " }}>Graph and Tree</h2>
                    </div> 
                    <div>
                    <h2 className="Btna" style={{marginTop:"10%"}}>Coming Soon...<span >&nbsp;     &nbsp;  </span>   </h2>
                    {/* <!-- <h2 className="Btna" style="margin-top: 0%;">Jao usse padao</h2> --> */}
        ...
        {/* <!-- ---- UNIT 4 CONTENT ------  --> */}
            ...
            <div id="unit4" className="tabcontent">
                    ...
                    <h2 className="movie-h1 webSeries-h1 movie-h1-transition  "  style={{fontSize:"xx-large " ,marginTop:"6% " }}>Branch & Bound Technique</h2>
                    </div> 
                    <div>
                    <h2 className="Btna" style={{marginTop:"10%"}}>Coming Soon...<span >&nbsp;     &nbsp;  </span>   </h2>
                    {/* <!-- <h2 className="Btna" style="margin-top: 0%;">Jao usse padao</h2> --> */}
        ...
        <div id="unit5" className="tabcontent">
            ...
            <section className="unit1Content">
                    ...
                    <h2 className="movie-h1 webSeries-h1 movie-h1-transition  "  style={{fontSize:"xx-large " ,marginTop:"6% " }}>Tractable and Intractable Problems</h2>
                </div> 
                <div>
                <h2 className="Btna" style={{marginTop:"10%"}}>Coming Soon...<span >&nbsp;     &nbsp;  </span>   </h2>
                {/* <!-- <h2 className="Btna" style="margin-top: 0%;">Jao usse padao</h2> --> */}
