  ...
  return (
    ...
    <div className="tab">
        ...
        <section className="unit1Content">
                ...
                <h2 className="movie-h1 webSeries-h1 movie-h1-transition  "  style={{fontSize:"xx-large " ,marginTop:"6% " }}>Control Unit</h2>
            </div> 
                <div>
                    <h2 className="Btna" style={{marginTop:"10%"}}>Coming Soon... <span >&nbsp;       &nbsp;  </span>   </h2>
                    {/* <!-- <h2 className="Btna" style="margin-top: 0%;">Jao usse padao</h2> --> */}
        ...
        {/* <!-- ---- UNIT 3 CONTENT ------  --> */}
            ...
            <div id="unit3" className="tabcontent">
                ...
                <section className="unit1Content">
                        ...
                        <h2 className="movie-h1 webSeries-h1 movie-h1-transition  "  style={{fontSize:"xx-large " ,marginTop:"6% " }}>CPU Design</h2>
                    </div> 
                    <div>
                    <h2 className="Btna" style={{marginTop:"10%"}}>Coming Soon...<span >&nbsp;     &nbsp;  </span>   </h2>
                    {/* <!-- <h2 className="Btna" style="margin-top: 0%;">Jao usse padao</h2> --> */}
        ...
        {/* <!-- ---- UNIT 4 CONTENT ------  --> */}
            ...
            <div id="unit4" className="tabcontent">
                    ...
                    <h2 className="movie-h1 webSeries-h1 movie-h1-transition  "  style={{fontSize:"xx-large " ,marginTop:"6% " }}>Memory Organization</h2>
                    </div> 
                    <div>
                    <h2 className="Btna" style={{marginTop:"10%"}}>Coming Soon...<span >&nbsp;     &nbsp;  </span>   </h2>
                    {/* <!-- <h2 className="Btna" style="margin-top: 0%;">Jao usse padao</h2> --> */}
        ...
        <div id="unit5" className="tabcontent">
            ...
            <section className="unit1Content">
                    ...
                    <h2 className="movie-h1 webSeries-h1 movie-h1-transition  "  style={{fontSize:"xx-large " ,marginTop:"6% " }}>Pipeline</h2>
                </div> 
                <div>
                <h2 className="Btna" style={{marginTop:"10%"}}>Coming Soon...<span >&nbsp;     &nbsp;  </span>   </h2>
                {/* <!-- <h2 className="Btna" style="margin-top: 0%;">Jao usse padao</h2> --> */}
...
export default CompSystemOrg3sem